...
let q5 = add_lots add empty [1] quan
let q6 = add_lots add q5 [2] quan
let q7 = add_lots add empty [1; 2; 4; 5; 8] quan
let q8 = join (join q5 q5) (join q6 q6)
let q9 = join (join q5 q6) (join q7 q8)

let l5a = add_lots app [] [1] quan
let l5b = 1::l5a
let l5c = List.tl(l5a)
let l6 = l5a @ (add_lots app [] [2] quan)
let l7 = List.sort compare (add_lots app [] [1; 2; 4; 5; 8] quan)
...
let q5 = add_lots add empty [-0.123] quan
let q6 = add_lots add q5 [21.1] quan
let q7 = add_lots add empty [-3.1; 22.1; -43.2; 115.0; 8.8] quan
let q8 = join (join q5 q5) (join q6 q6)
let q9 = join (join q5 q6) (join q7 q8);;

let app h t = h::t;;

let l5a = add_lots app [] [-0.123] quan;;
let l5b = (-0.123)::l5a;;
let l5c = List.tl(l5a);;
let l6 = l5a @ (add_lots app [] [21.1] quan);;
let l7 = List.sort compare (add_lots app [] [-3.1; 22.1; -43.2; 115.0; 8.8] quan);;
let l8 = List.sort compare (l5a @ (l5a @ (l6 @ l6)));;
let l9 = List.sort compare (l5a @ l6 @ l7 @ l8);;
...
let q5 = add_lots add empty [".24dz455"] quan
let q6 = add_lots add q5 ["forty-two"] quan
let q7 = add_lots add empty ["lorem"; "ipsum"; "dolor"; "sit"; "amet"] quan
let q8 = join (join q5 q5) (join q6 q6)
let q9 = join (join q5 q6) (join q7 q8);;

let app h t = h::t;;

let l5a = add_lots app [] [".24dz455"] quan;;
let l5b = (".24dz455")::l5a;;
let l5c = List.tl(l5a);;
let l6 = l5a @ (add_lots app [] ["forty-two"] quan);;
let l7 = List.sort compare (add_lots app [] ["lorem"; "ipsum"; "dolor"; "sit"; "amet"] quan);;
let l8 = List.sort compare (l5a @ (l5a @ (l6 @ l6)));;
let l9 = List.sort compare (l5a @ l6 @ l7 @ l8);;
